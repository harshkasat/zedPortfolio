    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary">
      <div className="container mx-auto px-4 py-8">
        <nav className="flex justify-between items-center mb-8">
          <a href="/"><h1 className="text-3xl font-bold">Ascii Convertor</h1></a>
        </nav>
            ...
            <CardContent className="p-6">
              <Tabs defaultValue="overview" className="w-full">
                ...
                <TabsContent value="overview" className="mt-6">
                  ...
                  The ASCII Video Converter is a Python-based tool that extracts frames from a video, 
                  converts them to ASCII art, and plays the ASCII video directly in the terminal. 
                  It allows users to control the playback speed.  
                  </p>
                </TabsContent>
                <TabsContent value="features" className="mt-6">
                  <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
                  <ul className="space-y-2">
                    {['Converts video frames to ASCII art', 'Playback control (increase/decrease speed, quit)', 'CLI-based tool for easy use.'].map((feature, index) => (
                      <motion.li 
                        key={index}
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {['Python', 'OpenCV', 'OpenCV', 'Pillow (PIL)', 'ascii-magic'].map((tech, index) => (
